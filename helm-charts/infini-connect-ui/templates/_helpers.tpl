...
*/}}
{{- define "infini-connect-ui.fullname" -}}
...
*/}}
{{- define "infini-connect-ui.chart" -}}
...
*/}}
{{- define "infini-connect-ui.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "infini-connect-ui.fullname" .) .Values.serviceAccount.name }}
{{- else }}
